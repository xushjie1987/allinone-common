...
/**
 * State machine topology. This object is semantically immutable. If you have a StateMachineFactory
 * there's no operation in the API that changes its semantic properties.
 *
 * @param <OPERAND>
...
final public class StateMachineFactory<OPERAND, STATE extends Enum<STATE>, EVENTTYPE extends Enum<EVENTTYPE>, EVENT> {
    ...
    /**
     * ClassName: ApplicableTransition <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:35:32 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory@param <OPERAND>
     * @version StateMachineFactory@param <STATE>
     * @version StateMachineFactory@param <EVENTTYPE>
     * @version StateMachineFactory@param <EVENT>
     * @since JDK 1.8
     */
    ...
    /**
     * ClassName: TransitionsListNode <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:35:36 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory
     * @since JDK 1.8
     */
    ...
    /**
     * ClassName: ApplicableSingleOrMultipleTransition <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:35:39 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory@param <OPERAND>
     * @version StateMachineFactory@param <STATE>
    ...
    /**
     * @return a NEW StateMachineFactory just like {@code this} with the current transition added as
     *         a new legal transition Note that the returned StateMachineFactory is a distinct
     *         object. This method is part of the API.
     * @param preState
     *            pre-transition state
     * @param postState
     *            post-transition state
     ...
     *         synchronization to build a state machine Note that the returned StateMachineFactory
     *         is a distinct object. This method is part of the API. The only way you could
     *         distinguish the returned StateMachineFactory from {@code this} would be by measuring
     *         the performance of the derived {@code StateMachine} you can get from it. Calling this
     *         is optional. It doesn't change the semantics of the factory, if you call it then when
     *         you use the factory there is no synchronization.
     */
    ...
    /**
     * ClassName: SingleInternalArc <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:35:59 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory
     * @since JDK 1.8
    ...
    private class SingleInternalArc implements Transition<OPERAND, STATE, EVENTTYPE, EVENT> {
        ...
        private SingleArcTransition<OPERAND, EVENT> hook;                               // transition
                                                                                        // hook
    ...
    /**
     * ClassName: MultipleInternalArc <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:36:03 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory
     * @since JDK 1.8
    ...
    /*
     * @return a {@link StateMachine} that starts in {@code initialState} and whose {@link
     * Transition} s are applied to {@code operand} . This is part of the API.
    ...
    /*
     * @return a {@link StateMachine} that starts in the default initial state and whose {@link
     * Transition} s are applied to {@code operand} . This is part of the API.
     * @param operand the object upon which the returned {@link StateMachine} will operate.
     */
    public StateMachine<STATE, EVENTTYPE, EVENT> make(OPERAND operand) {
    ...
    /**
     * ClassName: InternalStateMachine <br/>
     * Function: <br/>
     * date: 2016年12月31日 下午9:36:11 <br/>
     *
     * @author shengjie
     * @version StateMachineFactory
     * @since JDK 1.8
