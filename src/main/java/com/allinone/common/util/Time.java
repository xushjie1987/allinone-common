...
public final class Time {
     ...
     * computing how much longer to wait for an interval to expire. This function can return a
     * negative value and it must be handled correctly by callers. See the documentation of
